...
for sel_idxs in [nClass2_sel_idx, nClass3_sel_idx, nClass4_sel_idx]:
    for d_itr, d_idx in enumerate(sel_idxs):
        ...
        scores_df.loc[count:count+4059, "OA"] = pdeSegregate.feature_importances_
        scores_df.loc[count:count+4059, "OApw"] = pdeSegregatePW.feature_importances_
