...
for n_ in nRetainedFeatures:
    ...
    X = processedDatasets_dict["geneExpressionCancerRNA"]['X']
    y = processedDatasets_dict["geneExpressionCancerRNA"]['y']
    inds_topFeatures = topFeatures[:n_]
...
ds_results.to_csv(f"geneExpressionCancerRNA_latest_LOOCV.csv")
