...
print(oldKernels[3525][1]([0.0]))
print(oldKernels[3525][1]([-0.0015]))
print(oldKernels[3525][1]([0.0015]))

print(newKernels[3525][1]([0.0]))
print(newKernels[3525][1]([-0.0015]))
print(newKernels[3525][1]([0.0015]))

print(old_normalizedXdict[3525][0])
print(new_normalizedXdict[3525][0])
print(old_normalizedXdict[3525][1])
print(new_normalizedXdict[3525][1])
print(old_normalizedXdict[3525][2])
print(new_normalizedXdict[3525][2])
print(old_normalizedXdict[3525][3])
print(new_normalizedXdict[3525][3])
print(old_normalizedXdict[3525][4])
print(new_normalizedXdict[3525][4])
