...
if len(sys.argv) < 4:
    print(
        "Possible usage: python3.11 rmlater.py <processedDatasets> " +
...
# pdeSegregate.plot_overlapAreas(16920, legend=True, savefig=f"idx16920old")
# pdeSegregate.plot_overlapAreas(12537, legend=True, savefig=f"idx12537old")
# pdeSegregate.plot_overlapAreas(14792, legend=True, savefig=f"idx14792old")

# pdeSegregate.plot_overlapAreas(1842, legend=True, savefig=f"idx1842old")
# pdeSegregate.plot_overlapAreas(3525, legend=True, savefig=f"idx3525old")
# pdeSegregate.plot_overlapAreas(4368, legend=True, savefig=f"idx4368old")

# pdeSegregate.plot_overlapAreas(17547, legend=True, savefig=f"msurf_idx17547old")
# pdeSegregate.plot_overlapAreas(18492, legend=True, savefig=f"msurf_idx18492old")
# pdeSegregate.plot_overlapAreas(7949, legend=True, savefig=f"msurf_idx7949old")

# with open("pdes_old_Ai.pkl", "wb") as handle:
#     pickle.dump(pdeSegregate.intersectionAreas, handle)

# with open("pdes_old_kernels.pkl", "wb") as handle:
#     pickle.dump(pdeSegregate.feature_kernels, handle)
# # === === === === === === === === === === === === === === === === === === === ===

# Old 0.0 - 1.0  : [16920, 12537, 14792, 12580, 7813, 11258, 10971, 9297, 14991, 3526]
# New -1.0 - 2.0 : [1842, 3525, 4368]

# MSurf          : [17547, 18492, 7949, 6866, 5397, 14067, 6601, 9630, 19076, 6738]
